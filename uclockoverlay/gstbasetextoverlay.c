    ...
    GstVideoFrame * frame, gint x0, gint x1, gint y0, gint y1)
{
  ...
  switch (overlay->format) {
    ...
    //case GST_VIDEO_FORMAT_VYUY: // fix for centos 7
...
{
  if (!gst_element_register (plugin, "uclockoverlay", GST_RANK_NONE,
...
GST_PLUGIN_DEFINE (GST_VERSION_MAJOR, GST_VERSION_MINOR,
    uclockoverlay, "Pango-based text rendering and overlay", plugin_init,
